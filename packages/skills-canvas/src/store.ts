...
// short URL-safe id. The gateway's HTTP server mounts the handler from
// ./server.ts at `/canvas/:id`, so a user can `open
// http://localhost:PORT/canvas/<id>` to see whatever the agent rendered.
