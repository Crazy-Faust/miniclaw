// In-process handler for the bundled `database` skill. Runs a read-only SQL
// query against miniclaw's local SQLite DB after the guard in
// ../../src/lib/sql-security.ts approves it.
import Database from "better-sqlite3";
import { z } from "zod";
import { fail, ok, type Skill } from "@miniclaw/core";
import { checkSqlQuery } from "../../src/lib/sql-security.ts";
