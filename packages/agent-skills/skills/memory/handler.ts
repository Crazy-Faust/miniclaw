// In-process handler for the bundled `memory` skill. Writes durable source
// material into, and searches, the long-term memory store carried on
// SkillContext (wiki-aware stores return synthesized pages first).
import { z } from "zod";
import {
...
export const memorySkills: Skill[] = [writeMemorySkill, searchMemorySkill];
