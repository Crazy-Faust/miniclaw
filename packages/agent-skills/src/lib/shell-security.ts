// Owned by the shell skill: anyone changing the shell handler must update this
// guard. Keeping it co-located in lib makes the security contract auditable in
